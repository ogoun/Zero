...
namespace ZeroLevel.ML.DNN.Detectors
{
    ...
    {
        public Yolov5Detector(string modelPath, int deviceId) 
        ...
        public List<YoloPrediction> Predict(FastTensorPool inputs, float threshold = 0.6f)
        {
